        ...
        <div className="mt-8">
          <div className="inline">
            ...
            <p>
              ...
              <NewLine /> During football season, you’ll find me cheering on the Atlanta Falcons 🏈 
              and UGA Bulldogs 🐶. While studying at Boston University, I lived in Student Village 2 (StuVi2) 
              and played on the golf team. Go Terriers! 🐾
              <NewLine />
              I’m an entrepreneur, trader, quant, developer, and product manager driven by the thrill of building 
              impactful products. My focus is on creating meaningful solutions, working across the entire stack, 
              and using any tools or technologies necessary to make something truly awesome. 🤙
              <NewLine />
              Beyond technical expertise, I take pride in my adaptability and ability to wear many hats. I enjoy 
              talking to customers, managing products, designing, and documenting—all to bring projects to life 
              from end to end. 🚀
            </p>
          </div>
        </div>
